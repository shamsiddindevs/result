		...
		>
			<div className='flex items-center w-full max-w-[1200px] mx-auto px-5 gap-10'>
				...
				<ul className='flex items-center ml-auto gap-20 '>
					...
					<li>
						<button
							className='px-[15px] w-24 md:w-36 flex justify-center items-center font-semibold h-[45px] rounded-[10px] text-white  text-[18px] cursor-pointer transition-all uppercase'
							style={{
