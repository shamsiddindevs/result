    ...
    <section
      ...
      <div className="w-full max-w-[1200px] mx-auto px-5">
        ...
        <div className="grid grid-cols-1 gap-[15px] mx-auto max-w-780px">
          <div
            className={`flex flex-col w-full h-full ${!isActive&&"overflow-hidden max-h-[75px]"} rounded-[10px] py-[25px] pr-[10px] pl-5 `}
            style={{
          ...
          <div
            className={`flex flex-col w-full h-full ${!isActive2&&"overflow-hidden max-h-[75px]"} rounded-[10px] py-[25px] pr-[10px] pl-5 `}
            style={{
              backgroundColor: "rgb(125, 189, 70)",
              transition: "350ms ease-out",
            }}>
